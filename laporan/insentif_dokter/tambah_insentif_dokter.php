<!-- 
================= doc ====================
 filename     : tambah_insentif_dokter.php
...
<?php 
	...
	if(!empty($_POST['insentif_dokter_rekam_medis_id'])){
		...
		$param['insentif_dokter_terapi']			= $_POST['insentif_dokter_terapi'];
		$param['insentif_dokter_tanggal']			= tgl_sql($_POST['insentif_dokter_tanggal']);
		$param['insentif_dokter_hasil']				= $_POST['insentif_dokter_hasil'];
		$param['insentif_dokter_catatan']			= $_POST['insentif_dokter_catatan'];
		$param['created_by'] 				= $_SESSION['s_user'];

		$create_insentif_dokter 	= $insentif_dokter->create($param);
		$update_rekam_medis = $insentif_dokter->update_rm($param);
		$update_daftar 		= $insentif_dokter->update_daftar($param);

		if($create_insentif_dokter && $update_rekam_medis && $update_daftar){
			$sg   = "ok";
...
<form id="forms" method="post" onSubmit="return submitForm('<?php echo $_SERVER['PHP_SELF']; ?>')" class="form-horizontal">
	<fieldset>
		<legend>Peminsentif_dokteran</legend>
		<span>
		<?php
