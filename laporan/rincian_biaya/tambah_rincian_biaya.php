<!-- 
================= doc ====================
 filename     : tambah_rincian_biaya.php
...
<?php 
	...
	if(!empty($_POST['rincian_biaya_rekam_medis_id'])){
		...
		$param['rincian_biaya_terapi']			= $_POST['rincian_biaya_terapi'];
		$param['rincian_biaya_tanggal']			= tgl_sql($_POST['rincian_biaya_tanggal']);
		$param['rincian_biaya_hasil']				= $_POST['rincian_biaya_hasil'];
		$param['rincian_biaya_catatan']			= $_POST['rincian_biaya_catatan'];
		$param['created_by'] 				= $_SESSION['s_user'];

		$create_rincian_biaya 	= $rincian_biaya->create($param);
		$update_rekam_medis = $rincian_biaya->update_rm($param);
		$update_daftar 		= $rincian_biaya->update_daftar($param);

		if($create_rincian_biaya && $update_rekam_medis && $update_daftar){
			$sg   = "ok";
...
<form id="forms" method="post" onSubmit="return submitForm('<?php echo $_SERVER['PHP_SELF']; ?>')" class="form-horizontal">
	<fieldset>
		<legend>Pemrincian_biayaan</legend>
		<span>
		<?php
