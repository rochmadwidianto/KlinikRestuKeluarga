...
<?php 
	...
	if(!empty($_POST['pemeriksaan_rekam_medis_id'])){
		...
		$param['pemeriksaan_pasien_id']		= $_POST['pemeriksaan_pasien_id'];
		$param['status_pemeriksaan']			= 'Ya';
		$param['pemeriksaan_biaya']			= str_replace('.', '', $_POST['pemeriksaan_biaya']);
		...
		if($create_pemeriksaan && $update_daftar){
			$sg   = "ok";
