...
<!-- 
================= doc ====================
 filename     : lap_rekap_rincian_biaya.php
...
<div id="alert"></div>
<div class="row-fluid">
<h3 class="header smaller lighter blue"><b>Rekapitulasi Rincian Biaya Pemeriksaan</b></h3>
	<div class="table-header">		
	</div>

<form id="forms" method="post" action="laporan/rekap_rincian_biaya/print_action.php" target="_blank" class="form-horizontal">
<div class="span12">
		...
		<div class="controls">
			<select name="pasien_id" id="pasien_id" class="chzn-select span4" data-placeholder="-- Pilih Pasien --">
				...
				<?php					
					...
					$rekap_rincian_biaya->select_pasien($query);						
				?>
			</select>
		</div>
	</div>
		...
		<div class="controls">
			<select name="rekam_medis_nomor" id="rekam_medis_nomor" class="chzn-select span2" data-placeholder="-- Pilih No Rekam Medis --">
				...
				<?php					
					...
					$rekap_rincian_biaya->select_rm_nomor($query);						
				?>
			</select>
		</div>
	</div>
	...
	<div class="controls-group">
		<div class="controls">
			...
			<button href="javascript:void(0)" onclick="swapContent('laporan/rincian_biaya/rincian_biaya')" type="button" class="btn btn-small btn-danger" ><i class='icon-remove'><b> Batal</b></i></button>
		</div>
	</div>
	<hr>
	<div class="control-group">
