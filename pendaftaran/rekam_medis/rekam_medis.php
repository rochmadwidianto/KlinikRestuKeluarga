...
<script type="text/javascript">
	$(document).ready(function(){
		$("#data").load("pendaftaran/rekam_medis/data_rekam_medis.php");
		$("#id-breadcrumbs").html("Rekam Medis");
	});
	...
	function popupPasien(){
		$("#data").load("pendaftaran/rekam_medis/popup_pasien.php");
	}
	...
	function tambahForm(){
		...
		$.ajax({
			type:"GET",
			url:"pendaftaran/rekam_medis/tambah_rekam_medis.php",
			data:null,
			beforeSend:function(){
	...
	function deleteData(id,rekam_medis){
		...
		if(pilih==true){
				$.ajax({
					type:"GET",
					url:'pendaftaran/rekam_medis/hapus_rekam_medis.php',
	...
	function editData(id){
		$.ajax({
			type:"GET",
			url:'pendaftaran/rekam_medis/edit_rekam_medis.php',
			data:"rekam_medis_id="+id,
			beforeSend:function(){
				$("#form-nest").css({display:"block"});
				$("#form").html("<img src='assets/images/ajax-loader.gif' />");
