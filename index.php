...
<?php
include_once('config/cekSession.php');
include_once('config/fungsi_ago.php');
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Klinik Restu Keluarga | Home</title>
		...
		<div class="main-container container-fluid">
			...
			<div class="sidebar" id="sidebar">
				<div style="text-align: center; padding-top: 20px; padding-bottom: 10px;">
					<a  href="javascript:void(0)" onclick="swapContent('master_ref/user/det_user')" > 
						<?php $foto = 'master_ref/user/img_user/'.$_SESSION['foto_user']; ?>
						<img class="img-circle" src="<?php  echo $foto;?>" />
						<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
							<span style="font-weight: bold; text-align: center; color: #DCDCDC;">
								<?php echo strtoupper($_SESSION['s_nama'])?>
							</span>
						</div>
					</a>
				</div>
...
<!-- ================================================= End Navbar Right ================================================== -->
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs" >
					...
					<span><?php echo "<b> Nama : </b> ". $_SESSION['s_nama']." | <b> Level : </b> ". $_SESSION['s_level']." "; ?> </span> 
					</small>

					<small class="badge badge-important" style="float: right; margin-top: 1%; margin-right: 1%;">
					<span id="dates"><marquee width="170px" scrollamount="3"><span id="the-day">Hari, 00 Bulan 0000</span></marquee> | <span style="font-weight: bold;" id="the-time">00:00:00</span>
					</small>

					<div style="display: none;" class="nav-search" id="nav-search">
