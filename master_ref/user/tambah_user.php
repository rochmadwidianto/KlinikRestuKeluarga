...
<?php $foto = 'master_ref/user/img_user/profile-blank-man.png'; ?>
	...
	<div id="alert"></div>
		...
		<div class="row-fluid">
			...
			<div class="control-group">
					...
					<div class="controls">
						<input type="email" id="" name="email" autocomplete="off">
					</div>
				</div>
				<div class="control-group">
...
$("#multi-post").click(function(){
	if(document.multiform.username.value==""){
		...
		if(document.multiform.id_puskesmas.value==""){
			alert("Silahkan Pilih puskesmas !");
			document.multiform.id_puskesmas.focus();
			return false;
		}
